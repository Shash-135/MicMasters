    ...
    <>
      ...
      <section className="section-padding bg-cream">
        <div className="container course-list" style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          ...
          {/* Path 1 */}
          <article className="course-row course-row--online fade-up delay-100" id="online">
            <div className="course-info">
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', marginBottom: '1rem', color: 'var(--color-primary)' }}>15-Day Masterclass</h2>
              ...
              <ul className="feature-list feature-list--course">
            ...
            <div className="course-meta course-meta--online">
              <div className="meta-item"><i className="far fa-clock" style={{ color: 'var(--color-text-muted)' }}></i> 15 days, daily modules</div>
              <div className="meta-item"><i className="fas fa-laptop" style={{ color: 'var(--color-text-muted)' }}></i> Online (Pan-India)</div>
              <div className="meta-item"><i className="fas fa-users" style={{ color: 'var(--color-text-muted)' }}></i> Ages 15-25</div>
              <div className="meta-item"><i className="fas fa-certificate" style={{ color: 'var(--color-text-muted)' }}></i> Certification included</div>
          ...
          {/* Path 2 */}
          <article className="course-row course-row--intensive fade-up delay-200" id="intensive">
            <div className="course-info">
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', marginBottom: '1rem', color: 'var(--color-primary)' }}>5-Day Intensive Bootcamp</h2>
              <p className="lead" style={{ fontSize: '1.1rem', marginBottom: '2rem' }}>
            ...
            <div className="course-meta course-meta--intensive">
              <div className="meta-item"><i className="far fa-clock" style={{ color: 'var(--color-text-muted)' }}></i> 5-day intense format</div>
              <div className="meta-item"><i className="fas fa-map-marker-alt" style={{ color: 'var(--color-text-muted)' }}></i> Hosted at your venue</div>
              <div className="meta-item"><i className="fas fa-certificate" style={{ color: 'var(--color-text-muted)' }}></i> Certification included</div>
          ...
          {/* Path 3 */}
          <article className="course-row course-row--personal fade-up delay-300" id="personal-training">
            <div className="course-info">
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 4vw, 2.5rem)', marginBottom: '1rem', color: 'var(--color-primary)' }}>Personal Mentorship</h2>
              <p className="lead" style={{ fontSize: '1.1rem', marginBottom: '2rem' }}>
            ...
            <div className="course-meta course-meta--personal">
              <div className="meta-item"><i className="fas fa-user" style={{ color: 'var(--color-text-muted)' }}></i> 1-on-1 Coaching</div>
              <div className="meta-item"><i className="fas fa-sliders-h" style={{ color: 'var(--color-text-muted)' }}></i> 100% Customized</div>
              <div className="meta-item"><i className="far fa-calendar-check" style={{ color: 'var(--color-text-muted)' }}></i> Flexible Scheduling</div>
